  ...
  describe "#find_audit_update_date" do
    {
      ...
      "Audit réalisé le 1er décembre 2024. Suite à un audit de recette effectué en interne par l'Expert Accessibilité de la DILA mis à jour le 16 août 2024, le taux de conformité au RGAA v 4.1 est dorénavant de 88,52 %." => nil, # audit_date est postérieure
