class AuditsController < ApplicationController
  ...
  DEFAULT_INDEX_COLUMNS = %w[reachable compliance_rate declared_level legal_obligations declaration_quality evaluator organization_label tags].freeze
  ...
  def columns
    session[:audits_columns] = (DEFAULT_INDEX_COLUMNS | INDEX_COLUMNS.values.flatten) & params.expect(columns: [])
