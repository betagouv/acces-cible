  ...
  def attributes
    {
      ...
      Checks::AnalyzeAccessibilityPage.human(:compliance_rate) => [:audit, :analyze_accessibility_page, :compliance_rate],
      ...
      Checks::RunAxeOnHomepage.human(:success_rate) => [:audit, :run_axe_on_homepage, :success_rate],
    }
  end
